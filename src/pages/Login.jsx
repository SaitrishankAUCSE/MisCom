...
export default function Login() {
  ...
  return (
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}
      ...
      className="bg-background min-h-screen flex flex-col items-center justify-center relative overflow-x-hidden overflow-y-auto px-6 py-10 font-body-md text-on-background">
